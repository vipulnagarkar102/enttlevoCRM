  ...
  return (
    <div className="flex h-full w-full bg-surface font-body selection:bg-primary-container/30 overflow-hidden animate-in fade-in duration-300 relative">
      ...
      <aside className={`
        ...
        top-0 left-0 h-full
        w-[280px] border-r border-outline/10 flex flex-col bg-surface-container-low shrink-0
      ...
      <main className="flex-1 flex flex-col bg-surface overflow-hidden relative min-w-0">
        <header className="px-4 sm:px-8 py-3 sm:py-4 flex flex-wrap justify-between items-center gap-3 bg-surface border-b border-outline/10 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-[1.2rem] sm:text-[1.5rem] font-bold text-on-surface tracking-tighter uppercase font-headline">
        ...
        <div className="flex-1 flex flex-col overflow-auto">
          <div className="grid grid-cols-7 border-b border-outline/5 bg-surface-container shrink-0 min-w-[560px]">
            {['SUN', 'MON', 'TUE', 'WED', 'THU', 'FRI', 'SAT'].map(day => (
              <div key={day} className="py-2 text-[0.6rem] font-bold text-on-surface-variant/40 text-center tracking-[0.2em]">{day}</div>
            ))}
          </div>

          <div className={`flex-1 grid grid-cols-7 ${view === 'Month' ? 'grid-rows-[repeat(6,1fr)]' : 'grid-rows-1'} bg-surface/50 border-t border-outline/10 border-l border-outline/10 overflow-hidden min-w-[560px]`}>
