...
const LeadLabelsScatterChart: React.FC = () => {
  ...
  return (
    <div className="col-span-1 sm:col-span-1 xl:col-span-4 p-5 sm:p-6 bg-surface-container-low rounded-sm border border-outline/5 h-[400px] flex flex-col transition-colors duration-300">
      ...
      <div className="flex-1 h-[180px]">
        <ResponsiveContainer width="100%" height="100%">
          <ScatterChart margin={{ top: 20, right: 30, left: -20, bottom: 0 }}>
            ...
            />
            <Scatter name="Hot Leads" data={[{ x: 'Leads', y: 3.5 }, { x: 'Leads', y: 4 }, { x: 'Leads', y: 3.2 }]} fill="#f87171" />
            <Scatter name="Warm Leads" data={[{ x: 'Leads', y: 1.5 }, { x: 'Leads', y: 2.5 }, { x: 'Leads', y: 2 }]} fill="#fb923c" />
            <Scatter name="Cold Leads" data={[{ x: 'Leads', y: 0 }, { x: 'Leads', y: 0.5 }, { x: 'Leads', y: 0.2 }]} fill="#60a5fa" />
          </ScatterChart>
        </ResponsiveContainer>
      </div>
