...
const ColumnSettingsOverlay: React.FC<ColumnSettingsProps> = ({
  ...
  return (
    <>
      ...
      {/* Side Overlay */}
      <div className="fixed top-0 right-0 h-full w-[480px] bg-surface-container shadow-2xl z-[101] flex flex-col transform transition-transform duration-300 animate-slide-in-right border-l border-outline/10">
        {/* Header */}
        <div className="p-6 border-b border-outline/10 relative bg-surface-container-low">
          ...
          <div className="flex items-center gap-3 mb-6 pr-8">
            ...
            <h2 className="text-[0.95rem] font-bold text-on-surface uppercase tracking-tight whitespace-nowrap overflow-hidden text-ellipsis">
              Onboarding Table Column Settings
            </h2>
          </div>
