  ...
  const [notes, setNotes] = useState<Note[]>([
    {
      ...
      date: 'MAR 24, 2026 • 10:30 AM',
      content: 'Discussed the onboarding schedule with the client. They are ready for the configuration phase.\n\nAction Item: Send the configuration checklist by Friday.',
      isPinned: false
    },
    {
      id: '2',
      ...
      date: 'MAR 22, 2026 • 03:15 PM',
      content: 'Critical Integration Note:\nThe client has a custom ERP system. We need to schedule a call with their technical team to discuss API mapping.',
      isPinned: true
    }
  ]);
