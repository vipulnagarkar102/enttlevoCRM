...
interface ImportAccountsOverlayProps {
  isOpen: boolean;
  onClose: () => void;
}

const ImportAccountsOverlay: React.FC<ImportAccountsOverlayProps> = ({ isOpen, onClose }) => {
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="bg-primary-container/10 border border-primary-container/20 rounded-sm p-5 flex gap-2">
                  ...
                  <p className="text-[0.85rem] text-primary-container/90 leading-tight">
                    <strong className="font-bold">Important Note:</strong> All new accounts will appear in the "Unassigned" tab under the Onboarding section.
                  </p>
                </div>
              </div>
...
export default ImportAccountsOverlay;
