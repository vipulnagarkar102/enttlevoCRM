...
const TeamOnboardingPerformance: React.FC = () => {
  return (
    <div className="bg-surface border border-outline/10 rounded-sm p-6 shadow-sm flex flex-col h-[350px]">
      <h3 className="text-on-surface font-semibold mb-6">Team Onboarding Performance</h3>
...
export default TeamOnboardingPerformance;
