    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      <div className="relative bg-surface-container rounded-xl shadow-2xl w-full max-w-[450px] flex flex-col animate-in zoom-in-95 duration-200 border border-outline/10 overflow-hidden">
        ...
        <div className="p-8 pb-6 flex flex-col items-center text-center">
          ...
          <h2 className="text-[1.25rem] font-bold text-on-surface tracking-tight leading-tight mb-2">Delete Account?</h2>
          <p className="text-[0.9rem] text-on-surface-variant leading-relaxed max-w-[300px]">
            Are you sure you want to delete <span className="font-semibold text-on-surface">{accountName ? `"${accountName}"` : 'this account'}</span>? This action cannot be undone and the record will be permanently removed.
          </p>
        </div>
