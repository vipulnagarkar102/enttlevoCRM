...
const ComposeEmailOverlay: React.FC<ComposeEmailOverlayProps> = ({
  ...
  return (
    <>
      ...
      {/* Side Overlay */}
      <div className="fixed top-0 right-0 h-full w-full sm:w-[600px] max-w-full bg-surface shadow-2xl z-[101] flex flex-col transform transition-transform duration-300 animate-slide-in-right border-l border-outline/10">
        ...
        <div className="p-6 flex flex-col gap-5 border-t border-outline/10 mt-auto shadow-[0_-4px_30px_rgba(0,0,0,0.15)] dark:shadow-[0_-4px_30px_rgba(0,0,0,0.4)] relative z-10 bg-surface-container-low">
          <div className="flex flex-wrap items-center justify-between gap-4">
            {/* Formatting Tools */}
            <div className="flex flex-wrap items-center gap-1 sm:gap-2 text-on-surface-variant/60">
