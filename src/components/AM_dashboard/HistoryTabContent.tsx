...
const HistoryTabContent = () => {
  ...
  const [events] = useState<HistoryEvent[]>([
    ...
    },
    {
      ...
      title: 'AM Plan Uploaded',
      description: 'AM_Plan_v1.pdf has been uploaded to the account documents.',
      date: 'MAR 24, 2026',
      time: '11:00 AM'
    },
    {
    ...
    },
    {
      ...
      time: '02:30 PM',
      details: {
        subject: 'Your AM Portal Credentials',
        body: '"Hi Rama, please find your access details for the AM portal..." '
      }
    },
    {
      id: '1',
      type: 'lead_created',
      title: 'AM Initialized',
      description: 'Account initialized for AM from Sales handover.',
      date: 'MAR 20, 2026',
      time: '09:15 AM'
    }
  ]);
