...
import TaskManager from '../../components/AM_dashboard/TaskManager';
import CreateTaskOverlay from '../../components/AM_dashboard/CreateTaskOverlay';
...
const AMTasks: React.FC = () => {
    ...
    const handleAddTask = (taskData: any) => {
        console.log('AM Task submitted:', taskData);
