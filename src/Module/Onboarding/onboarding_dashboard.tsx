...
import CustomCalendar from '../../components/onboarding_dashboard/CustomCalendar';
import SankeyChart from '../../components/onboarding_dashboard/SankeyChart';
import UnassignedLeadsTable from '../../components/onboarding_dashboard/UnassignedAccountsTable';
import ManagersTable from '../../components/onboarding_dashboard/ManagersTable';
import TeamsTable from '../../components/onboarding_dashboard/TeamsTable';
import UsersTable from '../../components/onboarding_dashboard/UsersTable';
        ...
        <div className="max-w-[1400px] mx-auto space-y-6">
          ...
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4">
              <div className="text-left">
                <h1 className="text-[1.75rem] font-medium tracking-tight text-on-surface leading-tight font-headline uppercase">Onboarding</h1>
                <p className="text-on-surface-variant text-[0.9rem] mt-0.5 font-body">Q3 Fiscal Year Onboarding Performance Metrics</p>
              </div>
          ...
          {activeTab === 'Graph' ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-12 gap-5">
              <SankeyChart className="col-span-1 sm:col-span-2 xl:col-span-12" />
            </div>
            ...
            <div className="flex flex-col items-center justify-center h-[500px] bg-surface-container-low border border-outline/5 rounded-sm">
              ...
              <p className="text-on-surface-variant/60">Select the Graph tab to view active onboarding performance</p>
            </div>
          )}
        </div>
      </main>
