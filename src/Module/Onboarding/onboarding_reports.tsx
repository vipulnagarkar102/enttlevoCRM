...
import PhaseWiseRevenue from '../../components/onboarding_dashboard/PhaseWiseRevenue';
import EmptyChartState from '../../components/onboarding_dashboard/EmptyChartState';

const OnboardingReports: React.FC = () => {
          ...
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4">
              <div className="text-left">
                <h1 className="text-[1.75rem] font-medium tracking-tight text-on-surface leading-tight font-headline uppercase">Onboarding Reports</h1>
                <p className="text-on-surface-variant text-[0.9rem] mt-0.5 font-body">Detailed analysis of onboarding workflows and outcomes</p>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
              ...
              <div className="col-span-12 lg:col-span-7">
                <EmptyChartState title="Overall Feedback" message="No feedback surveys have been completed during this period." />
              </div>
            </div>
          </div>
        </div>
